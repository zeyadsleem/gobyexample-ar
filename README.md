...
- **يعمل دون اتصال:** يتم تخزين الموقع بالكامل في المتصفح عبر Service Worker بعد أول زيارة، فيعمل حتى بدون إنترنت مع تحديث تلقائي عند نشر نسخة جديدة.

## الخطوط المستخدمة

جميع الخطوط مستضافة محلياً من حزم Fontsource مع توليد خطوط بديلة مضبوطة المقاييس (Optimized Fallbacks) لمنع اهتزاز المحتوى (Layout Shift) أثناء تحميل الخطوط.
